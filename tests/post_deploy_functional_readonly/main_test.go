...
import (
	...
	testimpl "github.com/launchbynttdata/tf-azurerm-module_primitive-backup_policy_file_share/tests/testimpl"
)
...
func TestBackupPolicyFileShareModule(t *testing.T) {
